...
function doResolve(self, value) {
  ...
  self._queue.forEach((obj) => {
    obj.onFulfilled(self._value)
  });
}
...
Promise.prototype.then = function(onFulfilled, onRejected) {
  ...
  if (self._state !== _state_pending) {
    ...
    unwrap(promise, func, self._value);
  } else {
    wrapCallback.call(self, promise, onFulfilled, onRejected);
  }
